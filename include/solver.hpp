...
struct Solver
{
    ...
    void applyConstraintV3(float dt); // controle des collisions (obsolète)
    void apply_constraint(float dt);  // controle les collisions avec quelques fonctions auxiliaires
};
